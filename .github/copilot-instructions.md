# XMCL Copilot Instructions

*This instructions is generated by Copilot agent itself*

## Repository Overview

XMCL is a cross-platform Minecraft launcher built with **Tauri v2** architecture. It combines a **Rust backend** with a **Next.js frontend** to provide a native desktop application that supports Windows, macOS, and Linux.

XMCL is forked from SJMCL 0.5.0.
