...
pub async fn get_mod_info_from_jar(path: &PathBuf) -> XMCLResult<LocalModInfo> {
...
pub async fn get_mod_info_from_dir(path: &Path) -> XMCLResult<LocalModInfo> {
