...
#[tauri::command]
pub fn create_transient_task(app: AppHandle, desc: THandle) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn set_transient_task_state(app: AppHandle, task_id: u32, state: String) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn cancel_transient_task(app: AppHandle, task_id: u32) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn get_transient_task(app: AppHandle, task_id: u32) -> XMCLResult<Option<THandle>> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
  Ok(monitor.get_transient_task(task_id))
}

#[tauri::command]
pub fn cancel_progressive_task(app: AppHandle, task_id: u32) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn resume_progressive_task(app: AppHandle, task_id: u32) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub async fn restart_progressive_task(app: AppHandle, task_id: u32) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn stop_progressive_task(app: AppHandle, task_id: u32) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn cancel_progressive_task_group(app: AppHandle, task_group: String) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub async fn resume_progressive_task_group(app: AppHandle, task_group: String) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
...
#[tauri::command]
pub fn stop_progressive_task_group(app: AppHandle, task_group: String) -> XMCLResult<()> {
  let monitor = app.state::<Pin<Box<TaskMonitor>>>();
